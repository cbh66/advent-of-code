...
# idea: don't store num geode bots, just add time_left to resources[geode] to calculate all at once
# heuristic: if you can build a geode bot, then that should be the ONLY potential robot (?)
...
def main(inputs):
    ...
    for input in inputs:
        ...
        robots['ore'] = 1
        quality_level += num * max_geodes(Cache(), costs, resources, robots, NUM_MINUTES)[MATERIAL_TO_MAXIMIZE]
    print(quality_level)
